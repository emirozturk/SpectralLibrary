...
const handleDeleteUser = async (userId) => {
  ...
  await delWithToken("users", userId);
...
<template>
  <div class="p-8 max-w-7xl mx-auto bg-blue-50 shadow-md rounded-lg min-h-screen flex flex-col">
    ...
    <!-- Search Bar -->
    <div class="mb-6">
      <input type="text" placeholder="Search users by email, company, or user type..." v-model="searchQuery"
          ...
          <li v-for="user in filteredUsers" :key="user.id"
            ...
            <div class="flex-1">
              ...
              <p class="text-gray-700 flex items-center">
                Confirmed:
                <component :is="user.is_confirmed ? CheckCircleIcon : XCircleIcon" class="h-5 w-5 ml-1"
            ...
            <div class="flex space-x-2 mt-2 md:mt-0">
              ...
              <button @click="handleToggleConfirmed(user.id)" :class="[
                ...
                <component :is="user.is_confirmed ? XMarkIcon : CheckIcon" class="h-5 w-5 mr-1" />
              </button>
            </div>
          </li>
        </ul>
            ...
            <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 scale-95"
              ...
              <DialogPanel
                ...
                <div class="mt-4 space-y-4">
                  ...
                  <input type="text" placeholder="Company" v-model="newUserCompany"
                    class="w-full p-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  <Listbox v-model="newUserType">
                    <div class="relative">
                      ...
                      <!-- Use Transition (not TransitionChild) here -->
                      <Transition as="template" leave="transition ease-in duration-100" leave-from="opacity-100"
                        leave-to="opacity-0">
                        <ListboxOptions
                          ...
                          <ListboxOption v-for="(type, idx) in userTypes" :key="idx" :value="type"
                            v-slot="{ active, selected }">
                            <div :class="`relative cursor-pointer select-none py-2 pl-10 pr-4 ${active ? 'bg-blue-600 text-white' : 'text-blue-900'
                              }`">
          ...
          <div class="flex min-h-full items-center justify-center p-4 text-center">
            <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 scale-95"
              ...
              <DialogPanel
                ...
                <div class="mt-4 space-y-4">
                  <input type="email" placeholder="Email" v-model="editedUserEmail"
                    class="w-full p-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  <input type="text" placeholder="Company" v-model="editedUserCompany"
                    class="w-full p-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  <Listbox v-model="editedUserType">
                    <div class="relative">
                      ...
                      <!-- Use Transition with a real element by setting as="div" -->
                      <Transition as="div" leave="transition ease-in duration-100" leave-from="opacity-100"
                        leave-to="opacity-0">
                        <ListboxOptions as="ul"
                          ...
                          <ListboxOption as="li" v-for="(type, idx) in userTypes" :key="idx" :value="type"
                            v-slot="{ active, selected }">
                            <div
